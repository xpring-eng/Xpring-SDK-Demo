...
export class Meta extends jspb.Message {
  ...
  getDeliveredAmount(): rpc_v1_amount_pb.CurrencyAmount | undefined;
  setDeliveredAmount(value?: rpc_v1_amount_pb.CurrencyAmount): void;
...
export namespace Meta {
  export type AsObject = {
    ...
    deliveredAmount?: rpc_v1_amount_pb.CurrencyAmount.AsObject,
  }
}
...
export class AffectedNode extends jspb.Message {
  getLedgerEntryType(): rpc_v1_ledger_objects_pb.LedgerEntryType;
  setLedgerEntryType(value: rpc_v1_ledger_objects_pb.LedgerEntryType): void;
...
export namespace AffectedNode {
  export type AsObject = {
    ledgerEntryType: rpc_v1_ledger_objects_pb.LedgerEntryType,
...
export class CreatedNode extends jspb.Message {
  getNewFields(): rpc_v1_ledger_objects_pb.LedgerObject | undefined;
  setNewFields(value?: rpc_v1_ledger_objects_pb.LedgerObject): void;
...
export namespace CreatedNode {
  export type AsObject = {
    newFields?: rpc_v1_ledger_objects_pb.LedgerObject.AsObject,
  }
}

export class DeletedNode extends jspb.Message {
  getFinalFields(): rpc_v1_ledger_objects_pb.LedgerObject | undefined;
  setFinalFields(value?: rpc_v1_ledger_objects_pb.LedgerObject): void;
...
export namespace DeletedNode {
  export type AsObject = {
    finalFields?: rpc_v1_ledger_objects_pb.LedgerObject.AsObject,
  }
}
...
export class ModifiedNode extends jspb.Message {
  ...
  getPreviousFields(): rpc_v1_ledger_objects_pb.LedgerObject | undefined;
  setPreviousFields(value?: rpc_v1_ledger_objects_pb.LedgerObject): void;
...
export namespace ModifiedNode {
  export type AsObject = {
    finalFields?: rpc_v1_ledger_objects_pb.LedgerObject.AsObject,
    previousFields?: rpc_v1_ledger_objects_pb.LedgerObject.AsObject,
