...
export class SubmitTransactionResponse extends jspb.Message { 
    ...
    getEngineResult(): rpc_v1_meta_pb.TransactionResult | undefined;
    setEngineResult(value?: rpc_v1_meta_pb.TransactionResult): void;
...
export namespace SubmitTransactionResponse {
    export type AsObject = {
        engineResult?: rpc_v1_meta_pb.TransactionResult.AsObject,
