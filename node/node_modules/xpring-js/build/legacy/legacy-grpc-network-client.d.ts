 ...
 */
declare class LegacyGRPCNetworkClient implements LegacyNetworkClient {
    ...
    getLatestValidatedLedgerSequence(getLatestValidatedLedgerSequenceRequest: GetLatestValidatedLedgerSequenceRequest): Promise<LedgerSequence>;
    getTransactionStatus(getTransactionStatusRequest: GetTransactionStatusRequest): Promise<TransactionStatus>;
    XRPAmount(): XRPAmount;
    Payment(): Payment;
