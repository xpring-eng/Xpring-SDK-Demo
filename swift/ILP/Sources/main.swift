...
let getBalance = try ilpClient.getBalance(for: demoUserId, bearerToken: demoUserAuthToken)
...
let payment = try ilpClient.sendPayment(amount: amountToSend,
                                        paymentPointer: receiverPaymentPointer,
                                        senderAccountId: demoUserId,
                                        bearerToken: demoUserAuthToken)
...
let balanceAfterPayment = try ilpClient.getBalance(for: demoUserId, bearerToken: demoUserAuthToken);
